       ...
       <div className='flex flex-wrap gap-4 justify-center'>
         <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                ...
                <HiOutlineUserGroup 
                    className='bg-teal-600 p-3 text-white rounded-full text-5xl shadow-lg'
                    />
         ...
         <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                ...
                <HiAnnotation 
                    className='bg-indigo-600 p-3 text-white rounded-full text-5xl shadow-lg'
                    />
         ...
         <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
            <div className='flex justify-between'>
                ...
                <HiDocumentText
                    className='bg-lime-600 p-3 text-white rounded-full text-5xl shadow-lg'
                    />
